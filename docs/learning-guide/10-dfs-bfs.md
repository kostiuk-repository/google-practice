...
{
  "type": "graph",
  "title": "BFS поширюється рівнями від A",
  "values": ["A", "B", "C", "D", "E"],
  "edges": [[0,1],[0,2],[1,3],[2,3],[3,4]],
  "positions": [[0.18,0.20],[0.50,0.18],[0.18,0.72],[0.52,0.68],[0.84,0.48]],
  "steps": [
    {"label": "Стартуємо з A і додаємо його в queue", "active": [0], "prediction": {"prompt": "Які вершини BFS відкриє наступними?", "options": ["D і E", "B і C", "Лише B", "Усі одразу"], "answer": 1}},
    {"label": "B і C лежать на відстані 1", "active": [1,2], "visited": [0]},
    {"label": "D відкривається на відстані 2", "active": [3], "visited": [0,1,2]},
    {"label": "E досягається останньою на відстані 3", "active": [4], "visited": [0,1,2,3]}
  ]
}
```

...
{
  "type": "two-pointers",
  "title": "Two Sum у відсортованому масиві · target = 8",
  "values": [1, 2, 4, 6, 10],
  "steps": [
    {
      "label": "L=0, R=4: 1 + 10 = 11 — сума завелика",
      "note": "Відкидаємо праву межу: число 10 не дасть меншої суми з жодним правішим кандидатом.",
      "pointers": {"L": 0, "R": 4},
      "compare": [0, 4],
      "range": [0, 4],
      "prediction": {
        "prompt": "Сума 11 більша за target 8. Який pointer рухати?",
        "options": ["L вправо", "R вліво", "Обидва", "Жоден"],
        "answer": 1,
        "explanation": "У sorted array зменшити суму можна, пересунувши правий pointer до меншого значення."
      }
    },
    {
      "label": "L=0, R=3: 1 + 6 = 7 — сума замала",
      "note": "Рухаємо L вправо, бо з числом 1 та будь-яким меншим R сума не зросте до 8.",
      "pointers": {"L": 0, "R": 3},
      "compare": [0, 3],
      "visited": [4],
      "range": [0, 3],
      "prediction": {
        "prompt": "Сума 7 менша за target 8. Який наступний рух?",
        "options": ["L вправо", "R вліво", "R вправо", "Завершити"],
        "answer": 0,
        "explanation": "Потрібна більша сума, тому L переходить до більшого значення."
      }
    },
    {
      "label": "L=1, R=3: 2 + 6 = 8 — пару знайдено",
      "note": "Кожен рух був доведено безпечним, тому пропущених кандидатів немає.",
      "pointers": {"L": 1, "R": 3},
      "compare": [1, 3],
      "visited": [0, 4],
      "range": [1, 3]

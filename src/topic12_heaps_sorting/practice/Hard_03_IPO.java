...
public class Hard_03_IPO {
     ...
     *
     * You are given n projects where the i^th project has a pure profit profits[i] and
     ...
     * =========================================================================
     * Mentor Question: Чому тут використовуються дві купи — одна для фільтрації за капіталом, інша для вибору максимального прибутку?
     * 
     * Your Answer: 
     * 
     */

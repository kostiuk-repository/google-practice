...
public class Easy_03_RelativeRanks {

        /**
     * Problem: Relative Ranks
     *
     * You are given an integer array score of size n, where score[i] is the score of
     * the i^th athlete in a competition. All the scores are guaranteed to be unique.
     *
     * The athletes are placed based on their scores, where the 1^st place athlete has
     * the highest score, the 2^nd place athlete has the 2^nd highest score, and so on.
     ...
     * =========================================================================
     * Mentor Question: Яка часова складність сортування через Priority Queue порівняно із Arrays.sort()?
     * 
     * Your Answer: 
     * 
     */

...
public class Easy_09_CountUnreachablePairs {
     ...
     * from 0 to n - 1. You are given a 2D integer array edges where edges[i] = [a_i,
     * b_i] denotes that there exists an undirected edge connecting nodes a_i and b_i.
     *
     ...
     * =========================================================================
     * Mentor Question: Як обчислити кількість недосяжних пар на основі розмірів компонент зв'язності?
     * 
     * Your Answer: 
     * 
     */

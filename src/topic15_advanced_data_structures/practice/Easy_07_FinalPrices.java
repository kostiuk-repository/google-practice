...
public class Easy_07_FinalPrices {

        /**
     * Problem: Final Prices With a Special Discount in a Shop
     *
     * You are given an integer array prices where prices[i] is the price of the i^th
     * item in a shop.
     *
     ...
     * =========================================================================
     * Mentor Question: Чому монотонний стек зберігає індекси елементів, а не самі значення?
     * 
     * Your Answer: 
     * 
     */

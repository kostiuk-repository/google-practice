...
public class Medium_05_CarPooling {
     ...
     * [numPassengers_i, from_i, to_i] indicates that the i^th trip has numPassengers_i
     * passengers and the locations to pick them up and drop them off are from_i and
     * to_i respectively. The locations are given as the number of kilometers due east
     ...
     * =========================================================================
     * Mentor Question: How does a difference array keep track of passengers at each location?
     * 
     * Your Answer: 
     * 
     */
